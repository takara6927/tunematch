...
ActiveRecord::Schema[7.2].define(version: 2025_08_14_174828) do
  ...
  create_table "mbti_picks", force: :cascade do |t|
    t.string "mbti_code"
    t.string "artist"
    t.string "title"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mbti_code", "rank"], name: "index_mbti_picks_on_mbti_code_and_rank", unique: true
  end
